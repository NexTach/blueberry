...
export default function StartScreen({
  ...
  const showVoiceInput = isSpeechSupported && !showDirectInput;
  ...
  return (
    ...
    >
      {showVoiceInput ? (
        <div className="flex flex-col items-center" style={{ gap: mobileSpacing.section }}>
          <div className="flex justify-center">
            <button
              ...
              style={{
                ...
                boxShadow: '0 16px 30px rgba(79,107,255,0.26)',
              }}
              aria-label="음성 인식 시작"
            >
          ...
          >
            ...
            <button
              ...
              disabled={isInterpreting}
              className="w-full px-4 disabled:opacity-40"
              style={{
        ...
        <div className="w-full flex flex-col" style={{ gap: mobileSpacing.group }}>
          {isInterpreting && (
            <p
